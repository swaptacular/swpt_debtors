...
def upgrade():
    ...
    sa.Column('transfers_throttle_date', sa.DATE(), nullable=False, comment='The date at which `transfers_throttle_count` was zeroed out for the last time. This field is used to limit the number of issuing transfers per month that a debtor is allowed to make.'),
    sa.Column('transfers_throttle_count', sa.Integer(), nullable=False, comment='The number of issuing transfers that have been initiated after `transfers_throttle_date`. This field is used to limit the number of issuing transfers per month that a debtor is allowed to make. It gets zeroed out once a month.'),
    ...
    sa.CheckConstraint('transfers_throttle_count >= 0'),
