...
Revision ID: 51f0f8ce0fa6
Revises: 
Create Date: 2019-11-19 15:06:45.167975
...
def upgrade():
    ...
    op.create_table('recent_transfer',
    sa.Column('debtor_id', sa.BigInteger(), nullable=False),
    sa.Column('transfer_uuid', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('amount', sa.BigInteger(), nullable=False, comment='The amount to be transferred. Must be positive.'),
    sa.Column('transfer_info', postgresql.JSON(astext_type=sa.Text()), nullable=False, comment='A note from the debtor. Can be anything that the debtor wants the recipient to see.'),
    ...
    op.create_index('idx_issuing_coordinator_request_id', 'recent_transfer', ['debtor_id', 'issuing_coordinator_request_id'], unique=True)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_issuing_coordinator_request_id', table_name='recent_transfer')
    op.drop_table('recent_transfer')
