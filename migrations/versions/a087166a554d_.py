...
Revision ID: a087166a554d
Revises: 8d09bea9c7d1
Create Date: 2020-05-23 15:24:11.137735
...
def upgrade():
    ...
    sa.Column('transfer_notes', postgresql.JSON(astext_type=sa.Text()), nullable=False),
