...
Revision ID: a988b73a3fbc
Revises: 8d09bea9c7d1
Create Date: 2020-11-19 20:29:40.381339
...
def upgrade():
    ...
    sa.Column('running_transfers_count', sa.Integer(), nullable=False, comment='The number of initiated issuing transfers for this debtor. It is incremented when a new row for the debtor is inserted in the `initiated_transfer` table, and decremented when a row is deleted. It is needed for performance reasons.'),
